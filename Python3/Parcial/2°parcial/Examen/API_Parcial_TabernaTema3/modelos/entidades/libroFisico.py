...
class LibroFisico(Libro):
    ...
    @classmethod
    def fromDiccionario(cls, diccionario: dict) -> 'LibroFisico':
        
        return cls(diccionario['ISBN'], diccionario['titulo'], diccionario['autor'], diccionario['editorial'], diccionario['precio'], diccionario['stock'], diccionario['alto'], diccionario['ancho'], diccionario['grosor'], diccionario['tapaDura'], diccionario['peso'])
