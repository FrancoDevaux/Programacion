...
class LibroDigital(Libro):
    ...
    @classmethod
    def fromDiccionario(cls, diccionario: dict) -> 'LibroDigital':
        return cls(diccionario['ISBN'], diccionario['titulo'], diccionario['autor'], diccionario['editorial'], diccionario['precio'], diccionario['stock'], diccionario['formato'], diccionario['tamanioMB'], diccionario['proteccionDeCopia'])
